...
const LOG_FILE = path.join(OUTPUT_DIR, 'scrape-retry.log');
...
// Failed from log + products 141-167 never attempted
const RETRY_SLUGS = [
  // Failed from scrape.log
  'party-juice','buffet-fruit','sapphire-pine','sydney','santosa',
  'mango-1003','mango-1004','ace','wazir','cube-14',
  'spencer-small','spencer-big','checkmate-devine-big','checkmate',
  'checkmate-decor-big','checkmate-delight-big-1','shalimar',
  // Products 141-167 (never attempted)
  'bistro','shangrilla','summer','blossom','snow','spring','power',
  'pride','prestige','pedal-bin','abcd','santa','chimpu','little-heart',
  'genius','panda','pony','peppy','smiley','maggy','marina',
  'store-it-drawer-4','big-shoe-rack','big-multi-purpose-rack',
  'kinder','small-shoe-rack','small-multi-purpose-rack'
];
...
async function main() {
  ...
  log('=== MANGO RETRY START ===');
  log(`Retrying ${RETRY_SLUGS.length} slugs`);
