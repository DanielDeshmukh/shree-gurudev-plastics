...
const LOG_FILE = path.join(OUTPUT_DIR, 'scrape-retry3.log');
...
const RETRY_SLUGS = [
  'sapphire-pine','spencer-small','spencer-big',
  'checkmate-devine-big','checkmate','checkmate-decor-big',
  'checkmate-delight-big-1','peppy'
];
...
async function main() {
  ...
  log('=== MANGO RETRY 3 START ===');
  log(`Retrying ${RETRY_SLUGS.length} stubborn slugs with 45s timeout`);
