      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={clearCompare} className="px-4 py-2 text-sm font-medium text-red-600 border border-red-300 rounded-lg hover:bg-red-50 transition-colors">
              Clear All
            </button>
          </div>
        </div>
                      ...
                      {attr.key === "image" && (
                        <div className="flex flex-col items-center">
                          <button
                            ...
                            className="mb-2 text-xs text-red-500 hover:text-red-600 underline"
                          >
                            Remove
                          </button>
