...
export const metadata: Metadata = {
  ...
  description: "Shree Gurudev Plastics — Bhayander's #1 plastic products distributor and bulk seller. Buy plastic chairs, tables, buckets, containers, stools at wholesale prices. Serving Bhayander, Naigaon, Vasai, Virar, Mumbai. Top brands: Aristo, Mango Chairs, Milton. Contact for bulk orders.",
