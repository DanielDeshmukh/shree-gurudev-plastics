...
const FESTIVAL_TEMPLATES: Record<string, (name: string) => string> = {
  ...
  ganesh_chaturthi: (name) =>
    `Ganpati Bappa Morya!\n\nHappy Ganesh Chaturthi, ${name}!\n\nMay Lord Ganesha remove all obstacles from your path and bring prosperity, wisdom, and success to your business.\n\nWe have special festive offers on our entire range of plastic products - chairs, tables, stools, containers, buckets, and more at wholesale prices.\n\nBulk orders welcome! Ideal for Ganpati gatherings, events, and festive home preparation.\n\nShop now: ${SITE_URL}/products\nCall us: ${WHATSAPP_NUMBER}\n\nGanpati Bappa Morya!\n\n- Shree Gurudev Plastics`,
};
