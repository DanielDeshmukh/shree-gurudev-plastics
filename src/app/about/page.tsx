...
const faqs = [
  ...
  { question: "What brands do you distribute?", answer: "We distribute products from Aristo, KG Plast, Mango Chairs, Rajdhani, Cosmos, Milton, Borosil, Signoraware, and other leading plastic brands." },
        ...
        <section className="bg-white rounded-xl border border-gray-200 p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { title: "Top Brands", desc: "We stock only trusted brands — Aristo, KG Plast, Mango Chairs, Milton, and more." },
