      ...
      <div className={`${headingFont.variable} ${bodyFont.variable} font-body`}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          ...
          <div className="mt-8 mb-12 text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4 font-heading">Privacy Policy</h1>
            <div className="w-24 h-0.5 bg-gradient-to-r from-transparent via-primary-500 to-transparent mx-auto mb-4" />
            <p className="text-sm text-gray-500 italic">Effective Date: {lastUpdated}</p>
          </div>

          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 px-6 sm:px-10 py-10 sm:py-14 text-gray-700">

            <div className="space-y-10">

              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 font-heading border-b border-gray-100 pb-2">1. Introduction</h2>
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 font-heading border-b border-gray-100 pb-2">2. Information We Collect</h2>

                <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2 font-heading">2.1 Personal Information</h3>
                ...
                <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2 font-heading">2.2 Non-Personal Information</h3>
                ...
                <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2 font-heading">2.3 Cookies and Similar Technologies</h3>
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 font-heading border-b border-gray-100 pb-2">3. How We Use Your Information</h2>
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 font-heading border-b border-gray-100 pb-2">4. How We Share Your Information</h2>
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 font-heading border-b border-gray-100 pb-2">5. Data Security</h2>
                <p className="text-[15px] leading-[1.85] mb-3">
                ...
                <p className="text-[15px] leading-[1.85] mt-4 italic text-gray-600">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 font-heading border-b border-gray-100 pb-2">6. Data Retention</h2>
                <p className="text-[15px] leading-[1.85] mb-3">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 font-heading border-b border-gray-100 pb-2">7. Your Rights</h2>
                <p className="text-[15px] leading-[1.85] mb-3">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 font-heading border-b border-gray-100 pb-2">8. Third-Party Links</h2>
                <p className="text-[15px] leading-[1.85]">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 font-heading border-b border-gray-100 pb-2">9. Children&apos;s Privacy</h2>
                <p className="text-[15px] leading-[1.85]">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 font-heading border-b border-gray-100 pb-2">10. International Data Transfers</h2>
                <p className="text-[15px] leading-[1.85]">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 font-heading border-b border-gray-100 pb-2">11. Changes to This Policy</h2>
                <p className="text-[15px] leading-[1.85]">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 font-heading border-b border-gray-100 pb-2">12. Grievance Officer</h2>
                ...
                <div className="bg-gradient-to-br from-primary-50 to-orange-50/50 rounded-xl p-6 space-y-2 border border-primary-100">
                  ...
                  <p className="text-[15px] italic text-gray-600 mt-3">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 font-heading border-b border-gray-100 pb-2">13. Governing Law and Jurisdiction</h2>
                <p className="text-[15px] leading-[1.85]">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 font-heading border-b border-gray-100 pb-2">14. Contact Us</h2>
                <p className="text-[15px] leading-[1.85] mb-4">
