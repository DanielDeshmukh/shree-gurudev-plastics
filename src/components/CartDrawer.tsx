          ...
          <div className="flex-1 overflow-y-auto px-6 py-4">
            {items.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center">
                ...
                <p className="text-gray-400 text-sm">Add products to start your enquiry</p>
              </div>
            ) : (
          ...
          {items.length > 0 && (
            <div className="border-t border-gray-200 px-6 py-4 space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-green-500 text-white font-semibold py-3 rounded-lg hover:bg-green-600 transition-colors"
              >
