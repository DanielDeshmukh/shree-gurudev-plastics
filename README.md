...
|------|-----|-------------|
| Home | `/` | Hero, brands, featured products, FAQ |
| Products | `/products` | Searchable, filterable product grid with pagination |
| Brand | `/brand/[slug]` | Products by brand |
| Category | `/category/[slug]` | Products by category |
| Product Detail | `/product/[id]` | Full product info with comparison and cart |
| Compare | `/compare` | Side-by-side product comparison |
| Quote | `/quote` | Bulk/custom order request form |
| About | `/about` | Business story and service areas |
| Contact | `/contact` | Phone, WhatsApp, service areas |
| Admin Login | `/admin/login` | Admin authentication |
| Admin Dashboard | `/admin/dashboard` | Stats, charts, recent orders |
| Admin Products | `/admin/products` | Product CRUD management |
| Admin Brands | `/admin/brands` | Brand management |
| Admin Orders | `/admin/orders` | Order tracking and status |
| Admin Reports | `/admin/reports` | Sales reports with date range |
...
|--------|-------|-------------|
| GET/POST | `/api/products` | List (paginated) / Create products |
| GET/PUT/DELETE | `/api/products/[id]` | Single product CRUD |
| GET/POST | `/api/brands` | List / Create brands |
| GET/PUT/DELETE | `/api/brands/[id]` | Single brand CRUD |
...
| GET | `/api/reports` | Sales reports by date range |
